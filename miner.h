...
extern int scanhash_x13_opt(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done);
...
extern void free_x13_opt(int thr_id);
...
void x13_opt_hash(void *output, const void *input);
