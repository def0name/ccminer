/*
 * X13 optimized algorithm (bitcoin diamond)
 */
extern "C"
{
...
// Bitcoin Diamond X13 optimized CPU Hash
extern "C" void x13_opt_hash(void *output, const void *input)
{
	// blake1-bmw2-grs3-skein4-jh5-keccak6-sm3_7-cubehash8-shavite9-simd10-echo11-hamsi12-fugue13
...
extern "C" int scanhash_x13_opt(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done)
{
...
// cleanup
extern "C" void free_x13_opt(int thr_id)
{
	if (!init[thr_id])
		return;
